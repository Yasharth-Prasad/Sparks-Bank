...
<html lang="en" dir="ltr">
  ...
  <body style="background-color : #fff;">
    ...
    <!-- Introduction section -->
          <div class="row" style="background-color : #139487;">
            <div class="col-sm-12 col-md">
              <div class="heading text-center my-5">
                <h1><br><br>Welcome to <p>The Sparks Bank</p> </h1>
              </div>
            </div>
            <div class="col-sm-12 col-md img text-center my-5">
              <img src="images/bank.png" class="img-responsive pt-5" height="300">
            </div>
          </div>
          <!-- Activity Section -->
          <div class="row text-center">
                  <div class="col-md my-5">
                    <img src="images/create user.jpg" class="img-responsive" height="200">
                    <br>
                    <a href="createuser.php"><button type="button" class="btn btn-dark btn-lg">Create a User</button></a>
                  </div>
                  <div class="col-md my-5">
                    <img src="images/money transfer.png" class="img-responsive" height="200">
                    <br>
                    <a href="transfermoney.php"><button type="button" class="btn btn-dark btn-lg">Make a Transaction</button></a>
                  </div>
                  <div class="col-md my-5">
                    <img src="images/transaction history.png" class="img-responsive" height="200">
                    <br>
